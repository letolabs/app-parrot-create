# This Makefile is for the App::Parrot::Create extension to perl.
#
...
#     BUILD_REQUIRES => {  }
#     LICENSE => q[perl]
#     NAME => q[App::Parrot::Create]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], YAML=>q[0], Dancer=>q[1.304] }
#     VERSION_FROM => q[lib/App/Parrot/Create.pm]
#     clean => { FILES=>q[App-Parrot-Create-*] }
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = App::Parrot::Create
NAME_SYM = App_Parrot_Create
VERSION = 0.1
...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /home/leto/git/cxgn/local-lib
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
MAKE = make
FULLEXT = App/Parrot/Create
BASEEXT = Create
PARENT_NAME = App::Parrot
DLBASE = $(BASEEXT)
VERSION_FROM = lib/App/Parrot/Create.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
INST_LIBDIR      = $(INST_LIB)/App/Parrot
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/App/Parrot
...
TO_INST_PM = lib/App/Parrot/Create.pm

PM_TO_BLIB = lib/App/Parrot/Create.pm \
	blib/lib/App/Parrot/Create.pm
...
DISTNAME = App-Parrot-Create
DISTVNAME = App-Parrot-Create-0.1
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               App-Parrot-Create' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '    Dancer:      1.304' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Dancer::" VERSION="1.304" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/App/Parrot/Create.pm blib/lib/App/Parrot/Create.pm 
